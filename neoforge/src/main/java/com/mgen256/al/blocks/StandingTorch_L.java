...
public class StandingTorch_L extends StandingTorchBase implements StandingTorchLSpec {
    ...
    public StandingTorch_L(Block mainblock, String name) {
        super( mainblock, name, Shapes.or( PART_LOWER1, PART_LOWER2, PART_MID, PART_UPPER1, PART_UPPER2 ), PedestalSize.L );
      }
